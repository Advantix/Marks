	...
	if(carDataGetAfter!=null) {
		...
		$('#pickupTimeSelector').hide();
			htmlData='<div class=" checkout-grid clearfix">';
                htmlData+='<ul>';
		if(dealId!=null) {
			htmlData+='<li class="title">Order is empty!<a href="showMenu.html?itemId='+dealId+'"  class="ui-link-inherit" rel="external" style="color:#ff0000">&nbsp;Add items</a></li>';
		} else {
			htmlData+='<li class="title">Order is empty!<a href="showMenu.html"  class="ui-link-inherit" rel="external" style="color:#ff0000">&nbsp;Add items</a></li>';
		}
